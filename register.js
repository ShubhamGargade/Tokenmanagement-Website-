...
function validation1(){
  ...
  if(semail.length < 12 ){
    document.getElementById('se').innerHTML="*Email should be atleast 12 character long";
    return false;
  }
...
function validation2(){
  ...
  if(temail.length < 12 ){
    document.getElementById('te').innerHTML="*Email should be atleast 12 character long";
    return false;
  }
